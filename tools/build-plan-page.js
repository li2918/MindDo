...
<style>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .top h1{font-size:18px;font-weight:900;letter-spacing:-0.01em;flex:1;min-width:200px;}
  ...
  @media(max-width:640px){.doc{padding:24px 18px;}.wrap{padding:18px 14px 60px;}}
</style>
</head>
<body>
  <header class="top">
