(function () {
  ...
  var CSS = [
    ...
    "  background:none;border:1px solid var(--line,#e3d5bf);border-radius:999px;",
    "  padding:7px 12px;cursor:pointer;font-size:13px;font-weight:600;",
    "  color:var(--clay,#8f3c16);font-family:inherit;transition:.15s;line-height:1;",
    "}",
    ".lang-switcher .lang-trigger:hover,",
    ".lang-switcher.open .lang-trigger{background:var(--sand,#f6ead2);border-color:var(--gold,#c89429);}",
    ...
    "  background:#fff;border:1px solid var(--line,#e3d5bf);border-radius:12px;",
    "  box-shadow:0 10px 28px rgba(75,37,15,.12);",
    ...
    "  font-size:13px;font-weight:600;color:var(--clay,#8f3c16);",
    "  font-family:inherit;cursor:pointer;text-align:left;width:100%;transition:.15s;",
    "}",
    ".lang-switcher .lang-menu .lang-btn:hover{background:var(--sand,#f6ead2);}",
    ".lang-switcher .lang-menu .lang-btn.active{background:var(--sand,#f6ead2);}",
    ".lang-switcher .lang-menu .lang-btn.active::after{",
    "  content:\"✓\";margin-left:10px;color:var(--gold,#c89429);font-weight:700;",
    "}"
  ].join("\n");
